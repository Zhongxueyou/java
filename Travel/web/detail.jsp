...
<li>最大优惠：￥100</li>
<li>出游天数：5天</li>
<li>剩下票数：<strong>${productsum}</strong></li>
<li>提前报名：建议提前一天报名</li>
<!-- 点击添加到购物车，发出shopping请求，并将商品主键和要购买的商品数量作为参数传递到对应处理的servlet -->
<li><a href="shopping?pid=1&pquantity=1"><img src="images/jgwc.jpg" width="122" height="42" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="order.jsp"><img src="images/js.jpg" width="123" height="43" /></a></li>
</ul>
</div>
</div>
<div class="tuijian">
